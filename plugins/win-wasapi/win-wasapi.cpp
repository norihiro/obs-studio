...
/* definitions are consistent with FFmpeg */
...
void WASAPISource::UpdateSettings(obs_data_t *settings)
{
	...
	obs_source_set_async_compensation(source, async_compensation &
							  !useDeviceTiming);
}
